...
export default function Landing() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section
        id="hero"
        className="pt-28 min-h-screen container mx-auto px-4 flex items-center"
      >
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-5xl font-extrabold leading-tight">
              Stop Food Fraud with{" "}
              <span className="text-emerald-600">Hedera + AI</span>
            </h2>

            <p className="text-gray-600 dark:text-gray-300 text-lg">
              AgroDex creates a transparent agricultural supply chain using
              blockchain, AI auditing, and NFT-based batch identity.
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/verify">
                <Button
                  size="lg"
                  className="bg-white text-emerald-700 border border-emerald-200 dark:border-neutral-700"
                >
      ...
      >
        ...
        <p className="text-center max-w-3xl mx-auto text-gray-600 mb-12">
          Food fraud in agricultural supply chains destroys trust between
          farmers, distributors, and consumers, resulting in billions in losses
          and making product quality difficult to verify.
        </p>
      ...
      >
        ...
        <p className="text-center max-w-3xl mx-auto text-gray-600 mb-12">
          AgroDex builds a verifiable digital twin for every agricultural batch
          using blockchain immutability and AI auditing.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={card.title}
              className="p-6 border border-zinc-800 hover:border-emerald-900 rounded-xl bg-zinc-950 transition-colors"
            >
      ...
      <section id="fraud" className="py-24 container mx-auto px-4">
        ...
        <p className="text-center max-w-2xl mx-auto text-gray-600 dark:text-gray-300 mb-12">
          A deterministic fraud detection system powered by structured signals +
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 border rounded-xl">
            ...
            <p className="text-sm text-gray-500">
              7 rule-based fraud detectors generate a transparent 0–100 risk
              score.
            </p>
          </div>
      ...
      <section id="cta" className="py-24 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center p-14 rounded-2xl border border-emerald-900/60 bg-emerald-950/30">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Join AgroDex and make every agricultural product verifiable,
            transparent, and fraud-resistant.
          </p>
          <Link to="/register">
            <Button
              size="lg"
          ...
          <div className="grid md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-3 leading-relaxed">
                AI + Blockchain powered agricultural traceability platform built
                on Hedera Hashgraph.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div className="text-xs text-gray-400 mt-3">
                  Built for Hedera Hackathon • SSOC 2026
                </div>
              </div>
            </div>
          </div>
